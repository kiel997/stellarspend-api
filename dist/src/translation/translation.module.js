...
exports.TranslationModule = TranslationModule = __decorate([
    (0, common_1.Module)({ controllers: [translation_controller_1.TranslationController], providers: [translation_service_1.TranslationService], exports: [translation_service_1.TranslationService] })
], TranslationModule);
