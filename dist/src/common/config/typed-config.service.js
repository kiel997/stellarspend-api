...
exports.TypedConfigService = void 0;
const common_1 = require("@nestjs/common");
const config_1 = require("@nestjs/config");
/** Provides typed access to validated StellarSpend configuration. */
let TypedConfigService = class TypedConfigService {
    config;
    constructor(config) {
        this.config = config;
    }
...
exports.TypedConfigService = TypedConfigService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [config_1.ConfigService])
], TypedConfigService);
//# sourceMappingURL=typed-config.service.js.map