...
exports.SavingsModule = SavingsModule = __decorate([
    (0, common_1.Module)({ controllers: [savings_controller_1.SavingsController], providers: [savings_service_1.SavingsService], exports: [savings_service_1.SavingsService] })
], SavingsModule);
