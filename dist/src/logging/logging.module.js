...
exports.LoggingModule = LoggingModule = __decorate([
    (0, common_1.Module)({ controllers: [logging_controller_1.LoggingController], providers: [logging_service_1.LoggingService], exports: [logging_service_1.LoggingService] })
], LoggingModule);
