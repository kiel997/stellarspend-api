...
exports.BudgetsModule = BudgetsModule = __decorate([
    (0, common_1.Module)({ controllers: [budgets_controller_1.BudgetsController], providers: [budgets_service_1.BudgetsService], exports: [budgets_service_1.BudgetsService] })
], BudgetsModule);
